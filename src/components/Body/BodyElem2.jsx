...
export default function BodyElem2({ img, work, title, profile, name }) {
    return (
        <div className='w-[90%] min-h-[400px] mt-6 border border-slate-400'>
            ...
            <div className='datelocation w-[60%] px-3 flex justify-between mt-[-5px]'>
                <div className='date'>
                    <i class="ri-calendar-2-line mr-[4px]"></i>
                    Fri, 12 Oct, 2015
                </div>
            ...
            <div className='flex justify-center my-2'>
                <button className='w-[90%] py-2 text-orange-600 border border-slate-900 rounded-lg' >Visit Website</button>
            </div>
